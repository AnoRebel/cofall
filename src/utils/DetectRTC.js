...
(function () {
  ...
  var isNodejs = typeof process === "object" &&
    ...
    process.versions.node && /*node-process*/ !process.browser;
  if (isNodejs) {
    var version = process.versions.node.toString().replace("v", "");
    browserFakeUserAgent = "Nodejs/" + version + " (NodeOS) AppleWebKit/" +
      version + " (KHTML, like Gecko) Nodejs/" + version + " Nodejs/" + version;
  }
  ...
  function checkDeviceSupport(callback) {
    ...
    if (
      !navigator.enumerateDevices && window.MediaStreamTrack &&
    ...
    navigator.enumerateDevices(function (devices) {
      ...
      devices.forEach(function (_device) {
        ...
        if (!device.label) {
          ...
          if (
            typeof DetectRTC !== "undefined" && DetectRTC.browser.isChrome &&
            DetectRTC.browser.version >= 46 &&
            !/^(https:|chrome-extension:)$/g.test(location.protocol || "")
          ) {
            if (
              typeof document !== "undefined" &&
              typeof document.domain === "string" && document.domain.search &&
  ...
  var isNodeWebkit = typeof process === "object" &&
    typeof process.versions === "object" && process.versions["node-webkit"];
  ...
  if (!/^(https:|chrome-extension:)$/g.test(location.protocol || "")) {
    var isNonLocalHost = typeof document !== "undefined" &&
      typeof document.domain === "string" && document.domain.search &&
      document.domain.search(/localhost|127.0./g) === -1;
    if (
      isNonLocalHost &&
      (DetectRTC.browser.isChrome || DetectRTC.browser.isEdge ||
  ...
  ["AudioContext", "webkitAudioContext", "mozAudioContext", "msAudioContext"]
    .forEach(function (item) {
      ...
      if (item in window) {
        ...
        if (
          window[item] && "createMediaStreamSource" in window[item].prototype
        ) {
  ...
  if (
    DetectRTC.browser.isChrome && DetectRTC.browser.version >= 46 &&
    !/^(https:|chrome-extension:)$/g.test(location.protocol || "")
  ) {
    if (
      typeof document !== "undefined" && typeof document.domain === "string" &&
  ...
  DetectRTC.displayAspectRatio = getAspectRatio(screen.width, screen.height)
    .toFixed(2);
  ...
  DetectRTC.isWebSocketsSupported = "WebSocket" in window &&
  ...
  if (
    ...
    DetectRTC.browser.isChrome && typeof webkitRTCPeerConnection !== "undefined"
  ) {
